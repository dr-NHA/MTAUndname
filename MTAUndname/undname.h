...
extern "C" __declspec( dllexport ) char* __cdecl unDName(char*,const char*,int,unsigned short,GetParameter_t=0);
extern "C" __declspec( dllexport ) char* __cdecl UndecorateSymbolName(char*,unsigned short,GetParameter_t=0);
extern "C" __declspec( dllexport ) void* __cdecl CreateUndecorator(unsigned short,GetParameter_t=0);
extern "C" __declspec( dllexport ) char* __cdecl UndecoratorUndecorateSymbolName(void*,char*);
extern "C" __declspec( dllexport ) void __cdecl UndecoratorDispose(void* Undec);
...
static	const const char* tokenTable[]={
	#if !VERS_32BIT
	"__near",		// TOK_near
	"__near ",		// TOK_nearSp
	"__near*",		// TOK_nearP
...
static	const const char* nameTable[]={
	" new",
	" delete",
	"=",
	">>",
...
static const const char* ehTable[]={
" Ptr to Member Data'",
" Catchable Type'",
...
static const const char* rttiTable[]={
" Type Descriptor'",
...
#define PDT_GCPointer			'A'
#define PDT_PinnedPointer		'B'
...
#define SHF_CPPManagedNativeFunction		'G'
#define SHF_CPPManagedILMain				'H'
#define SHF_CPPManagedNativeMain			'I'
#define SHF_CManagedILFunction				'J'
#define SHF_CManagedNativeFunction			'K'
